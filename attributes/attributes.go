...
func EnvOpt() celgo.EnvOption {
	...
	ret = append(ret, decls.NewIdent("path", decls.String, nil))
	ret = append(ret, decls.NewIdent("ip", decls.String, nil))
	ret = append(ret, decls.NewIdent("token", decls.String, nil))
